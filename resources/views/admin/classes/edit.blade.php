...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <form method="POST" action="{{ route('admin.classes.update', $class) }}" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6" onsubmit="return confirmUpdate(this, 'Bạn có chắc chắn muốn cập nhật lớp học này?');">
            @csrf
            @method('PUT')
            ...
            <div class="mt-6 flex justify-end gap-3">
                <a href="{{ route('admin.classes.show', $class) }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700">
                    Hủy
                </a>
        ...
        <form method="POST" action="{{ route('admin.classes.destroy', $class) }}" class="mt-6 bg-red-50 dark:bg-red-900/20 rounded-lg shadow p-6"
