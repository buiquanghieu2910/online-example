...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow">
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        ...
        <a href="{{ route('teacher.exams.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Tạo bài tập mới
        </a>
    </div>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($exams as $exam)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500 dark:text-gray-400">{{ $exam->duration }} phút</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('teacher.exams.show', $exam) }}" class="text-blue-600 hover:text-blue-900 mr-3 dark:text-blue-400 dark:hover:text-blue-300">Xem</a>
                                <a href="{{ route('teacher.questions.index', $exam) }}" class="text-green-600 hover:text-green-900 mr-3 dark:text-green-400 dark:hover:text-green-300">Câu hỏi</a>
                                <a href="{{ route('teacher.exams.edit', $exam) }}" class="text-yellow-600 hover:text-yellow-900 mr-3 dark:text-yellow-400 dark:hover:text-yellow-300">Sửa</a>
                                <a href="{{ route('teacher.exams.assign', $exam) }}" class="text-purple-600 hover:text-purple-900 mr-3 dark:text-purple-400 dark:hover:text-purple-300">Phân công</a>
                                <form action="{{ route('teacher.exams.destroy', $exam) }}" method="POST" class="inline" onsubmit="return confirmDelete(this, 'Bạn có chắc chắn muốn xóa bài tập này?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">Không tìm thấy bài tập nào.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
                ...
                <div class="flex justify-between items-start mb-3">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-700 rounded-lg shadow-lg py-1 z-10 border border-gray-200 dark:border-gray-600">
                            <a href="{{ route('teacher.exams.show', $exam) }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <a href="{{ route('teacher.questions.index', $exam) }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('teacher.exams.edit', $exam) }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('teacher.exams.assign', $exam) }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <span class="flex items-center">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <form action="{{ route('teacher.exams.destroy', $exam) }}" method="POST" onsubmit="return confirmDelete(this, 'Bạn có chắc chắn muốn xóa bài tập này?');">
                                @csrf
                                @method('DELETE')
