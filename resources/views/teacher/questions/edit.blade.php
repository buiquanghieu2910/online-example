...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    ...
    <form action="{{ route('teacher.questions.update', [$exam, $question]) }}" method="POST" id="questionForm" enctype="multipart/form-data" onsubmit="return confirmUpdate(this, 'Bạn có chắc chắn muốn cập nhật câu hỏi này?');">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('teacher.questions.index', $exam) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 dark:bg-gray-600 dark:hover:bg-gray-700 dark:text-gray-100 font-bold py-2 px-4 rounded">
                Hủy
            </a>
