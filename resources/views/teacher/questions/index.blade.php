    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('teacher.questions.create', $exam) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Thêm câu hỏi
                </a>
                <a href="{{ route('teacher.exams.show', $exam) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 dark:bg-gray-600 dark:hover:bg-gray-700 dark:text-gray-100 font-bold py-2 px-4 rounded">
                    Quay lại bài tập
                </a>
            </div>
        </div>
            ...
            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-4">
                <div class="flex justify-between items-start mb-3">
                    ...
                    <div class="flex space-x-2 ml-4">
                        <a href="{{ route('teacher.questions.edit', [$exam, $question]) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">Sửa</a>
                        <form action="{{ route('teacher.questions.destroy', [$exam, $question]) }}" method="POST" class="inline" onsubmit="return confirmDelete(this, 'Bạn có chắc chắn muốn xóa câu hỏi này?');">
                            @csrf
                            @method('DELETE')
