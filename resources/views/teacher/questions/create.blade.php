...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    ...
    <form action="{{ route('teacher.questions.store', $exam) }}" method="POST" id="questionForm" enctype="multipart/form-data" onsubmit="return confirmUpdate(this, 'Bạn có chắc chắn muốn tạo câu hỏi mới?');">
        @csrf
