...
const PRIME_COLOR_KEY = 'online-exam-prime-color';
...
export const useThemeStore = defineStore('theme', {
    ...
    getters: {
        ...
        primeColorOptions: () => Object.keys(PRIME_COLORS),
        primePaletteMap: () => PRIME_COLORS,
    },
    actions: {
        initTheme() {
            ...
            const savedPrimeColor = localStorage.getItem(PRIME_COLOR_KEY);
            this.primeColor = PRIME_COLORS[savedPrimeColor] ? savedPrimeColor : 'emerald';

            this.applyTheme();
            this.applyPrimeColor();
        ...
        applyPrimeColor() {
            updatePrimaryPalette(PRIME_COLORS[this.primeColor] || PRIME_COLORS.emerald);
        },
        setPrimeColor(color) {
            if (!PRIME_COLORS[color]) return;
            this.primeColor = color;
            localStorage.setItem(PRIME_COLOR_KEY, color);
            this.applyPrimeColor();
        },
    },
});
